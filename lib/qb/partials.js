...
function matviews (db) {
	if (x.dialect == 'pg') {
		return `select matviewname as viewname from pg_matviews where schemaname = ${x.wrap(db)} order by matviewname;`;
	}
}
...
exports = module.exports = function (instance) {
    ...
    return {
        ...
        tables:tables, matviews: matviews, views:views, columns:columns
    }
}
